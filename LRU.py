...
#print('Menor Tempo =  Ref {} | Tempo {}'.format(quadros2[0].obterValor(), quadros2[0].obterTempo()))
...
if limite != 1: #se nao chegou no fim da lista de referencias
    ...
    while n != 0:
        ...
        if verifica == True: #se o valor estiver no quadro
            ...
            #print('Referencia {} | Tempo = {}'.format(referencias[indice].obterValor(), referencias[indice].obterTempo()))
            ...
            indideadc = k #para saber qual o indice que vai ser adicionado a nova referencia
        ...
        if indice==len(referencias): #quando chegar no fim do arquivo de referencias n=0 para parar o laço
            n=0
            print(faltadePG)  # printando a quantidade de falta de paginas
